...
## 4. velocyto.R
The RNA velocity estimates and clustering was performed with the velocyto.R package. Full documentation is to be found [here](tSNE_velocyto.Md)

## Acknowledgements
We would like to thank Adam Hargreaves with the help and support during the project. Tylyn pahkan tietäjät Taiton veroista laskentasampoa eivät suoneet; onneksi soisen maan asukit minulle tämän ovat luoneet. 

## Author contributions
AE and EP conceived of the research theme and prepared the presentation togehter with AJ, JN and SS. AE and EP reviwed and selected cells for analysis. AE was in contact with Adam Hargreaves to analyse the initial set of 4 cells on the ARC cluster. JN, SS and AJ performed the data analysis. JN provided access to the Taito cluster and prepared the Github.  
